...
// static
void WindowsToFrontPlugin::RegisterWithRegistrar(
  ...
  auto plugin = std::make_unique<WindowsToFrontPlugin>(registrar);
...
WindowsToFrontPlugin::WindowsToFrontPlugin(flutter::PluginRegistrarWindows *registrar)
  : registrar_(registrar) {}

WindowsToFrontPlugin::~WindowsToFrontPlugin() {}

void WindowsToFrontPlugin::HandleMethodCall(
